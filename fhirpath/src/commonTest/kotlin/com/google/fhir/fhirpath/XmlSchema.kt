...
@Serializable
@XmlSerialName("group")
data class Group(val name: String, val reference: String? = null, @XmlElement(true) val notes: String? = null, val description: String? = null, val tests: List<Test>)
...
data class Expression(val invalid: Boolean? = null, val mode: String? = null, @XmlValue val value: String)
