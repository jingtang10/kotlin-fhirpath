...
class FhirPathCodegenPlugin : Plugin<Project> {
  override fun apply(project: Project) {
    project.extensions.create("fhirPathCodegenExtension", FhirPathCodegenExtension::class)
  }
}

abstract class FhirPathCodegenExtension @Inject constructor(private val project: Project) {
